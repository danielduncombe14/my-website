    ...
    <div className="min-h-screen pt-24 pb-16 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-12 text-center">
          <h1 className="text-4xl sm:text-5xl font-bold mb-4" data-testid="text-business-blog-title">
            Business Blog
          </h1>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Professional insights, industry trends, and strategic thinking
          </p>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
            {posts?.map((post) => (
              ...
              >
                <Link href={`/business-blog/${post.id}`}>
